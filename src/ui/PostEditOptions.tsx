...
const PostEditOptions: React.FC<PostEditOptionsProps> = ({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 w-64 origin-top-right rounded-md bg-white shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none">
          {/* MENU HEADER */}
